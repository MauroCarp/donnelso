                            ...
                            <div class='row'>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group" id="inputCaravanaParto">
                                        ...
                                        <input type="text" class="form-control" id="caravanaParto" placeholder="N° Caravana" required>  
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fechaParto" id="fechaParto" class="form-control">
                            ...
                            <div class="col-xs-12 col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="cantidadNacidos" class="form-control">
                            ...
                            <div class="col-xs-12 col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="sexoParto">
                                        ...
                                        <input type="radio" name="sexo" value="M" style="height:20px;width:20px;"><b>M</b>
                            ...
                            <div class="col-xs-12 col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="checkbox" id="mellizos" style="height:20px;width:20px">
